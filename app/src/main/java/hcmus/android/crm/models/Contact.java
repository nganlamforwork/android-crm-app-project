...
public class Contact extends ContactId implements Parcelable {
    ...
    public Contact(String name, String email, String phone, String address, String job, String company, String notes, String image, String latitude, String longitude) {
        this.name = name;
        this.image = image;
        this.email = email;
        this.phone = phone;
